...
from bi_meta_yc_public_dataset_api.app import PublicDatasetApiAppFactoryYC
...
class DefaultPublicDatasetApiAppFactoryYC(PublicDatasetApiAppFactoryYC):
...
def create_app(setting: AsyncAppSettings, test_setting: Optional[TestAppSettings] = None) -> web.Application:
    data_api_app_factory = DefaultPublicDatasetApiAppFactoryYC()
