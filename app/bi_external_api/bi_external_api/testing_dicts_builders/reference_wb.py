...
def build_reference_workbook(conn_name: str, fill_defaults: bool = False) -> dict[str, Any]:
    ...
    chart_inst_list = [
        #
        chart_builder.add_formula_field(f_id="order_week", formula="DATETRUNC([date], 'week')", cast="date")
        .with_visualization(
            {
                "kind": "area_chart",
        ...
        #
        chart_builder.add_formula_field(f_id="order_month", formula="DATETRUNC([date], 'month')", cast="date")
        .with_visualization(
            {
        ...
        chart_builder.with_visualization(
            {
                ...
                "sort": [{"source": ds_f_ref("region"), "direction": "ASC"}],
                "coloring": {
                    "kind": "dimension",
                    "source": ds_f_ref("category"),
                    "palette_id": "default-palette",
        ...
        chart_builder.with_visualization(
            {
                ...
                "sort": [{"source": ds_f_ref("region"), "direction": "DESC"}],
                "coloring": {
                    "kind": "dimension",
                    "source": ds_f_ref("category"),
                    "palette_id": "default-palette",
        ...
        chart_builder.with_visualization(
            {
                ...
                "sort": [{"source": ds_f_ref("sum_sales"), "direction": "DESC"}],
                "coloring": None,
            }
        ).build_instance("ch_flat_table_sales_per_subcategory_per_segment"),
        #
        chart_builder.add_formula_field(f_id="order_year", formula="DATETRUNC([date], 'year')", cast="date")
        .with_visualization(
            {
                "kind": "pivot_table",
                "columns": [
                ...
                "measures": [{"source": ds_f_ref("sum_sales")}],
                "sort": [{"source": ds_f_ref("order_year"), "direction": "DESC"}],
                "coloring": {
                    "source": ds_f_ref("sum_sales"),
                    "spec": {"kind": "gradient_2_points", "palette": None, "thresholds": None},
                },
            }
        )
        ...
        #
        chart_builder.add_formula_field(f_id="max_profit", formula="MAX([profit])", cast="float")
        .with_visualization(
            {
                "kind": "scatter_plot",
                ...
                "sort": [],
                "coloring": {"kind": "dimension", "source": ds_f_ref("category"), "palette_id": None, "mounts": []},
    ...
    dash_inst = (
        DashJSONBuilderSingleTab([ch_inst["name"] for ch_inst in chart_inst_list])
        .with_fill_defaults(fill_defaults)
