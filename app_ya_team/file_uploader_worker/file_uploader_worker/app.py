...
from file_uploader_worker import app_version
from file_uploader_worker.app_factory import FileUploaderWorkerFactoryYT
...
def load_settings() -> FileUploaderWorkerSettings:
...
def run_standalone_worker() -> None:
    ...
    worker = FileUploaderWorkerFactoryYT(settings=settings).create_worker()
    configure_logging(
