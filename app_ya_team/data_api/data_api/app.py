...
from data_api.app_factory import DataApiAppFactoryYT
...
def create_app(
    setting: DataApiAppSettingsYT,
    connectors_settings: dict[ConnectionType, ConnectorSettingsBase],
) -> web.Application:
    data_api_app_factory = DataApiAppFactoryYT(settings=setting)
