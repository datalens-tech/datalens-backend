...
SECRETS_YC_PREPROD = {
        ...
        "values": [
            {
                "yav_id": "sec-01dc24ppx88wd8wjawzp3zwxcg",
                "keys": [
                    "YA_MUSIC_PODCAST_STATS_PASSWORD",
                    "MOYSKLAD_DB_USER_PASSWORD",
                    "MOYSKLAD_PARTNER_KEYS",
                    "BITRIX_DB_USER_PASSWORD",
                    "BITRIX_PARTNER_KEYS",
                    "CH_SCHOOLBOOK_PASSWORD",
            ...
            },
            {
                ...
                "remap": {
                    "PARTNER_KEYS": "KONTUR_MARKET_PARTNER_KEYS",
                    "ch-password": "KONTUR_MARKET_DB_USER_PASSWORD",
                },
            },
            {
    ...
    "bi-backend-dls": {
        ...
        "values": [
            {"yav_id": "sec-01dc24ppx88wd8wjawzp3zwxcg", "keys": ["DLS_DB_PASSWORD", "DLS_SENTRY_DSN"]},
            {
    ...
    "bi-backend-file-uploader": {
        ...
        "values": [
            ...
            {"yav_id": "sec-01cramk07fz80xzkj80f4nkd82", "keys": ["testing"], "remap": {"testing": "CSRF_SECRET"}},
            {
        ...
        "values": [
            {
                ...
                "keys": [
                    ...
                    "LOGS_CH_PASSWORD",
                    "EXT_QUERY_EXECUTER_SECRET_KEY",
                    "IAM_SERVICE_ACCOUNT_KEY_DATA",
                    "COMPONENTS_CERT_CHAIN",
                    "COMPONENTS_CERT_KEY",
                    "IAM_INTERACTION_SERVICE_ACCOUNT_KEY_DATA",
                    "TVM_INFO",
                    "TVM_SECRET",  # TODO: get rid of it
                ],
            },
            {
...
def get_yav_secret(yav_sec_id: str) -> dict[str, str]:
    resp = requests.get(f"{YAV_ENDPOINT}/1/versions/{yav_sec_id}", headers={"Authorization": f"OAuth {YAV_TOKEN}"})
        ...
        for yav_info in sec_info["values"]:
            ...
            for key in yav_info["keys"]:
                ...
                if key not in values:
                    ...
                    continue
                entries.append({"key": remapper(key), "textValue": values[key]})
