...
def register_dialect():
    sa.dialects.registry.register("bi_mssql_basic", "dl_sqlalchemy_mssql.base", "BIMSSQLDialectBasic")
    sa.dialects.registry.register("bi_mssql", "dl_sqlalchemy_mssql.base", "BIMSSQLDialect")
