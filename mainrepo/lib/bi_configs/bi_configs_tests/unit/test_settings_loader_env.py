...
from bi_configs.environments import CommonInstallation, InstallationsMap, EnvAliasesMap
from bi_configs.settings_loaders.common import SDict
from bi_configs.settings_loaders.fallback_cfg_resolver import ConstantFallbackConfigResolver, YEnvFallbackConfigResolver
...
def test_yenv_cfg_revolver(yenv_type_val, expected_fallback):
    ...
    assert isinstance(fallback, CommonInstallation)
