        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = DataLensParser.BinaryExprContext(
                            self, DataLensParser.ExprMainContext(self, _parentctx, _parentState)
                        )
                        ...
                        localctx = DataLensParser.ComparisonChainContext(
                            self, DataLensParser.ExprMainContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_exprMain)
                        self.state = 300
                        ...
                        localctx = DataLensParser.BetweenExprContext(
                            self, DataLensParser.ExprMainContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_exprMain)
                        self.state = 303
                        ...
                        localctx = DataLensParser.UnaryPostfixContext(
                            self, DataLensParser.ExprMainContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_exprMain)
                        self.state = 313
                        ...
                        localctx = DataLensParser.InExprContext(
                            self, DataLensParser.ExprMainContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_exprMain)
                        self.state = 319
        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = DataLensParser.BinaryExprSecContext(
                            self, DataLensParser.ExprSecondaryContext(self, _parentctx, _parentState)
                        )
