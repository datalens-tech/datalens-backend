...
from bi_connector_postgresql.formula_ref.human_dialects import HUMAN_DIALECTS
from bi_connector_postgresql.formula_ref.i18n import CONFIGS, Translatable
...
class PostgresSQLFormulaRefPlugin(FormulaRefPlugin):
    ...
    compeng_support_dialects = frozenset((
        *PostgreSQLDialect.POSTGRESQL.to_list(),  # FIXME: NON_COMPENG_ ?
    ))
