...
from dl_query_processing.utils.name_gen import NameGen
...
class SlicerFactoryBase(abc.ABC):
    ...
    @abc.abstractmethod
    def _make_boundary(self, level_idx: int, slicer_config: SlicerConfiguration, iteration_id: str) -> LevelBoundary:
    ...
    def get_boundary(
        self,
        level_idx: int,
        slicer_config: SlicerConfiguration,
        iteration_id: str,
    ) -> LevelBoundary:
