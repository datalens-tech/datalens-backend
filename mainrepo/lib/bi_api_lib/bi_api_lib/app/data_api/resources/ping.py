...
from bi_core.connection_executors.models.constants import HEADER_REQUEST_ID
...
class PingReadyView(BaseView):
    ...
    async def get(self) -> web.Response:
        ...
        status = 200 if all(ping_result == 200 or ping_result is True for ping_result in response_details.values()) else 503
