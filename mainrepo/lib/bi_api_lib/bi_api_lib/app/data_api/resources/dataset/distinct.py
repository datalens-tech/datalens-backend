...
class DatasetDistinctView(DatasetDataBaseView, abc.ABC):
    ...
    # @schematic_request(
    #     ns=ns, body=bi_api_lib.schemas.data.DatasetVersionValuesDistinctPostSchema(),
    #     responses={200: ('Success', bi_api_lib.schemas.data.DatasetVersionValuesDistinctResponseSchema())}
    # )
...
class DatasetDistinctViewV1(DatasetDistinctView):
    ...
    def load_req_model(self) -> DataRequestModel:
        schema = bi_api_lib.schemas.data.DatasetVersionValuesDistinctPostSchema()
...
class DatasetDistinctViewV1_5(DatasetDistinctView):
    ...
    def load_req_model(self) -> DataRequestModel:
        schema = bi_api_lib.schemas.data.DistinctDataRequestV2Schema()
        req_model: DataRequestModel = schema.load(self.dl_request.json)
        return req_model
