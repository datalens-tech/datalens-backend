...
class DatasetRangeView(DatasetDataBaseView, abc.ABC):
    ...
    # @schematic_request(
    #     ns=ns, body=bi_api_lib.schemas.data.DatasetVersionValuesRangePostSchema(),
    #     responses={200: ('Success', bi_api_lib.schemas.data.DatasetVersionValuesRangeResponseSchema())}
    # )
...
class DatasetRangeViewV1(DatasetRangeView):
    ...
    def load_req_model(self) -> DataRequestModel:
        schema = bi_api_lib.schemas.data.DatasetVersionValuesRangePostSchema()
...
class DatasetRangeViewV1_5(DatasetRangeView):
    ...
    def load_req_model(self) -> DataRequestModel:
        schema = bi_api_lib.schemas.data.RangeDataRequestV2Schema()
        req_model: DataRequestModel = schema.load(self.dl_request.json)
        return req_model
