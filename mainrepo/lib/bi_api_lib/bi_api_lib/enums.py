...
from bi_constants.enums import BIType, WhereClauseOperation, AggregationFunction as ag
...
_FILT_STR = frozenset((
    W.STARTSWITH, W.ISTARTSWITH, W.ENDSWITH, W.IENDSWITH,
    W.CONTAINS, W.ICONTAINS, W.NOTCONTAINS, W.NOTICONTAINS,
))
_FILT_ARRAY = _FILT_NULL | _FILT_EQNEQ | frozenset((
    W.STARTSWITH,
    W.CONTAINS, W.NOTCONTAINS,
    W.LENEQ, W.LENNE, W.LENGT, W.LENGTE, W.LENLT, W.LENLTE,
))
...
CASTS_BY_TYPE = {
    BIType.datetime: [BIType.genericdatetime, BIType.datetime, BIType.date, BIType.string, BIType.integer, BIType.float, BIType.boolean],
    BIType.datetimetz: [BIType.datetimetz, BIType.genericdatetime, BIType.date, BIType.string, BIType.integer, BIType.float, BIType.boolean],
    BIType.genericdatetime: [BIType.genericdatetime, BIType.date, BIType.string, BIType.integer, BIType.float, BIType.boolean],
    ...
    BIType.string: [BIType.string, BIType.date, BIType.genericdatetime, BIType.boolean, BIType.integer, BIType.float,
                    BIType.geopoint, BIType.geopolygon],
