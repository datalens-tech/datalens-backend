...
from bi_sqlalchemy_common.base import CompilerPrettyMixin  # noqa: E402
...
def register_dialect():
    sa.dialects.registry.register("bi_oracle_basic", "bi_sqlalchemy_oracle.base", "BIOracleDialectBasic")
    sa.dialects.registry.register("bi_oracle", "bi_sqlalchemy_oracle.base", "BIOracleDialect")
