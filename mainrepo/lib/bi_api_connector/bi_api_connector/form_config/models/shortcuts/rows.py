...
from bi_api_connector.form_config.models.common import MarkdownStr, CommonFieldName, BooleanField
from bi_api_connector.form_config.models.rows.base import TDisplayConditions
from bi_api_connector.form_config.models import rows as C

from bi_api_connector.i18n.localizer import Translatable
...
class RowConstructor:
    ...
    def host_row(
        ...
        return C.CustomizableRow(items=[
            ...
            C.InputRowItem(name=CommonFieldName.host, width='l', default_value=default_value, display_conditions=display_conditions),
        ])
    ...
    def port_row(
        ...
        return C.CustomizableRow(items=[
            ...
            C.InputRowItem(name=CommonFieldName.port, width='s', control_props=C.InputRowItem.Props(type='number'), default_value=default_value),
        ])
    ...
    def db_name_row(
        ...
        return C.CustomizableRow(items=[
            C.LabelRowItem(text=self._localizer.translate(label_text), display_conditions=display_conditions),
            C.InputRowItem(name=CommonFieldName.db_name, width='l', default_value=default_value, display_conditions=display_conditions)
        ])
