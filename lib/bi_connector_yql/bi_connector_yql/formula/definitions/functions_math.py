...
DEFINITIONS_MATH = [
    # abs
    base.FuncAbs(variants=[
        V(D.YQL, sa.func.Math.Abs),  # `Math::Abs(…)`
    ]),

    # acos
    base.FuncAcos(variants=[
        V(D.YQL, sa.func.Math.Acos),
    ]),

    # asin
    base.FuncAsin(variants=[
        V(D.YQL, sa.func.Math.Asin),
    ]),

    # atan
    base.FuncAtan(variants=[
    ...
    # sin
    base.FuncSin(variants=[
        V(D.YQL, sa.func.Math.Sin),
    ]),

    # sqrt
    base.FuncSqrt(variants=[
