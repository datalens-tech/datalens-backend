...
@attr.define(kw_only=True, slots=False)
class CounterRequestContextMixin(dl_app_api_base.BaseRequestContext[CounterRequestContextDependenciesMixin]):
...
@attr.define(kw_only=True, slots=False)
class ValueRequestContextMixin(dl_app_api_base.BaseRequestContext[ValueRequestContextDependenciesMixin]):
    @dl_app_base.singleton_class_method_result
...
@attr.define(kw_only=True, slots=False)
class RequestContextDependencies(CounterRequestContextDependenciesMixin, ValueRequestContextDependenciesMixin):
    ...


@attr.define(kw_only=True, slots=False)
class RequestContext(CounterRequestContextMixin, ValueRequestContextMixin):
    ...
