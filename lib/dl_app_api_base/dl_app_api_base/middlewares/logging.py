...
class LoggingMiddleware:
    _request_context_manager: request_context.DefaultRequestContextManager

    def _request_to_string(self, request: aiohttp.web.Request) -> str:
        request_context = self._request_context_manager.get()
        request_id = request_context.get_request_id()
        return f"Request(method={request.method}, path={request.path}, request_id={request_id})"
