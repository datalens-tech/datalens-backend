...
from bi_connector_postgresql.core.postgresql_base.type_transformer import PG_TYPES_INT, PG_TYPES_FLOAT, PG_TYPES_STRING
from bi_core.db.sa_types_base import (
    make_native_type, simple_instantiator, typed_instantiator, timezone_instantiator,
)
...
SQLALCHEMY_POSTGRES_TIMEZONE_TYPES = (
    pg_types.TIMESTAMP,
)
...
SQLALCHEMY_POSTGRES_TYPES = {
    ...
    **{
        make_native_type(CONNECTION_TYPE_POSTGRES, pg_types.ARRAY(inner_typecls)):
            typed_instantiator(pg_types.ARRAY, inner_typecls)
