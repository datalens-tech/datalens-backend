...
from bi_api_lib_tests.db.data_api.result.complex_queries.generation.generator import (
    AutoGeneratorSettings, TestSettings, LODTestAutoGenerator,
)
from bi_api_lib_tests.db.data_api.result.complex_queries.generation.runner import PreGeneratedLODTestRunner
...
def test_new_auto_generated(api_v1, data_api_v2, dataset_id):
    autogen_settings = AutoGeneratorSettings(
        dimensions=(
            'Category', 'City',
            'Order Date', 'Region',
            'Ship Date', 'Ship Mode', 'Sub-Category',
        ),
