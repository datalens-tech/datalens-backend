...
EXCEPTION_CODES = {
    ...
    common_exc.EstimatedExecutionTooLong: status.BAD_REQUEST,
    common_exc.InvalidSplitSeparator: status.BAD_REQUEST,
    common_exc.TooManyColumns: status.BAD_REQUEST,
    ...
    exc.BillingActionNotAllowed: status.BAD_REQUEST,
    ...
    exc.UnsupportedOffsetError: status.BAD_REQUEST,
    exc.CompengNotSupported: status.BAD_REQUEST,
    exc.UnsupportedForEntityType: status.BAD_REQUEST,
    exc.IAMUserError: status.BAD_REQUEST,
