    ...
    sections=[
        Section(
            ...
            connectors=[
                ...
                Connector(conn_type=CT.chydb, hidden=False),
        ...
        Section(
            ...
            connectors=[
                ...
                Connector(conn_type=CT.usage_tracking, hidden=False),
            ],
        ),
        Section(
            ...
            connectors=[
                ...
                Connector(conn_type=CT.equeo, hidden=False),
                Connector(conn_type=CONNECTION_TYPE_MARKET_COURIERS, hidden=False),
                Connector(conn_type=CONNECTION_TYPE_SCHOOLBOOK_JOURNAL, hidden=True),
                Connector(conn_type=CONNECTION_TYPE_SMB_HEATMAPS, hidden=False),
                Connector(conn_type=CT.kontur_market, hidden=False),
            ],
        )
    ],
)
