...
from bi_formula.mutation.lookup import LookupFunctionToQueryForkMutation, LookupDefaultBfbMutation
...
def test_ago_to_query_fork_mutation():
    formula_obj = n.formula(
        n.func.SOMEFUNC(n.func.AGO(n.func.SUM(n.field('f1')), n.field('date')))
    )
...
def test_lookup_default_bfb_mutation():
    ...
    assert formula_obj == n.formula(
        n.func.SOMEFUNC(
            n.func.AGO(
                n.func.SUM(n.field('f1')), n.field('date'),
