        ...
        variants=[
            V(
                ...
                lambda array: n.func.IF(
                    ...
                    None,
                    sa.func.array(
                        sa.select(sa.cast(sa.func.unnest(array), sa.TEXT)).distinct().scalar_subquery()
                    ),
                ),
            ),
        ]
        ...
        variants=[
            V(
                ...
                lambda array: n.func.IF(
                    ...
                    None,
                    sa.func.array(
                        sa.select(sa.cast(sa.func.unnest(array), sa.BIGINT)).distinct().scalar_subquery()
                    ),
                ),
            ),
        ]
        ...
        variants=[
            V(
                ...
                lambda array: n.func.IF(
                    ...
                    None,
                    sa.func.array(
                        sa.select(sa.cast(sa.func.unnest(array), sa_postgresql.DOUBLE_PRECISION)).distinct().scalar_subquery()
                    ),
                ),
            ),
        ]
