        ...
        variants=[
            V(
                ...
                lambda array: n.func.IF(
                    array == None,
                    None,
                    sa.func.array(sa.select(sa.cast(sa.func.unnest(array), sa.TEXT)).distinct().scalar_subquery()),
                ),
            ),
        ]
    ),
        ...
        variants=[
            V(
                ...
                lambda array: n.func.IF(
                    array == None,
                    None,
                    sa.func.array(sa.select(sa.cast(sa.func.unnest(array), sa.BIGINT)).distinct().scalar_subquery()),
                ),
            ),
        ]
    ),
