...
class PostgreSQLTypeTransformer(TypeTransformer):
    ...
    native_to_user_map = {
        ...
        **{
            make_native_type(pg_types.ARRAY(typecls)): UserDataType.array_int
            for typecls in PG_TYPES_INT
        },
        **{
            make_native_type(pg_types.ARRAY(typecls)): UserDataType.array_float
            for typecls in PG_TYPES_FLOAT
        },
        **{
            make_native_type(pg_types.ARRAY(typecls)): UserDataType.array_str
