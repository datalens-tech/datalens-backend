...
from dl_connector_postgresql.core.postgresql.settings import DeprecatedPostgreSQLSettingDefinition
...
class PostgreSQLCoreConnectionDefinition(CoreConnectionDefinition):
    ...
    settings_definition = DeprecatedPostgreSQLSettingDefinition
    allow_export = True
