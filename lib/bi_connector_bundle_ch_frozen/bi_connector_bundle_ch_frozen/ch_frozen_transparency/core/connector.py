...
from bi_connector_bundle_ch_frozen.ch_frozen_transparency.core.settings import CHFrozenTransparencySettingDefinition
...
class CHFrozenTransparencyCoreConnectionDefinition(CHFrozenBaseCoreConnectionDefinition):
    ...
    settings_definition = CHFrozenTransparencySettingDefinition
