"""
Python Database API Specification 2.0 interface implementation for AppMetrica API
...
from dl_sqlalchemy_metrica_api import metrika_dbapi
from dl_sqlalchemy_metrica_api.api_client import APPMETRICA_API_HOST
from dl_sqlalchemy_metrica_api.api_info.appmetrica import (
