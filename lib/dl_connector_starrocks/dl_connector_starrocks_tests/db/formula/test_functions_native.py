...
class TestNativeFunctionStarRocks(StarRocksTestBase, DefaultNativeFunctionFormulaConnectorTestSuite):
...
class TestNativeAggregationFunctionStarRocks(
    StarRocksTestBase, DefaultNativeAggregationFunctionFormulaConnectorTestSuite
):
    pass
