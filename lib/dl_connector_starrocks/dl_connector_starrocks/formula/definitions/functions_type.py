...
DEFINITIONS_TYPE = [
    ...
    base.FuncBoolFromNull(
        variants=[
            V(D.STARROCKS, lambda _: sa.cast(sa.null(), sa_mysql.TINYINT())),
        ]
    ),
    ...
    base.FuncFloatFromDate(
        variants=[
            V(D.STARROCKS, lambda value: sa.cast(sa.func.UNIX_TIMESTAMP(value), sa_mysql.DOUBLE)),
        ]
    ),
    ...
    base.FuncIntFromNull(
        variants=[
            V(D.STARROCKS, lambda _: sa.cast(sa.null(), sa_mysql.BIGINT())),
        ]
    ),
    ...
    base.FuncIntFromDatetime(
        variants=[
            V(D.STARROCKS, lambda value: sa.cast(sa.func.UNIX_TIMESTAMP(value), sa_mysql.BIGINT)),
        ]
    ),
