...
from bi_cloud_integration.iam_mock import (
    FAKE_SERVICE_LOCAL_METADATA_IAM_TOKEN, AuthConfigHolder, IAMServicesMockFacade,
)
...
def apply_iam_services_mock(monkeypatch: Any) -> Generator[IAMServicesMockFacade, None, None]:
    ...
    monkeypatch.setattr(bi_cloud_integration.local_metadata, 'get_yc_service_token_local_details',
