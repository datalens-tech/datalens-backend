...
from dl_maintenance.api.helpers import get_sync_usm, get_dataset
from dl_maintenance.api.data_access import get_result_data, make_query_spec_union

mm = MaintenanceEnvironmentManager(app_settings_cls=DataApiAppSettings, app_factory_cls=StandaloneDataApiAppFactory)
ds = get_dataset(mm, 'hfu4hg98wh48', is_async_env=True)
