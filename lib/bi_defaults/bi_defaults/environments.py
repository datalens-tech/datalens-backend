...
class InternalTestingInstallation(cd.ConnectorsDataFileIntTesting, CommonInternalInstallation):
    ...
    SENTRY_DSN_TEST_TASK_PROCESSOR_WORKER: ClassVar[
        str
    ] = "https://73342d1c7a6b419bb61d584a55ad1920@sentry.stat.yandex-team.ru/546"
    SENTRY_DSN_FILE_UPLOADER_API: ClassVar[
        str
    ] = "https://fd9661c6d3ff46408b5bf230ae67c503@sentry.stat.yandex-team.ru/548"
    SENTRY_DSN_FILE_UPLOADER_WORKER: ClassVar[
        str
    ] = "https://4f1a5b79e0f4445bab103aaf312e0b38@sentry.stat.yandex-team.ru/547"
                ...
                connectors=[
                    ConnectorContainerSettings(
                        ...
                        title_translatable=TranslatableSettings(
                            text="label_connector-ch_over_yt_group", domain=DOMAIN_CHYT_INTERNAL
                        ),
                        includes=[
...
class InternalProductionInstallation(cd.ConnectorsDataFileIntProduction, CommonInternalInstallation):
    ...
    SENTRY_DSN_FILE_UPLOADER_API: ClassVar[
        str
    ] = "https://7e0c1d1acdab440f8ea879f46cfaffa6@sentry.stat.yandex-team.ru/549"
    SENTRY_DSN_FILE_UPLOADER_WORKER: ClassVar[
        str
    ] = "https://693332c6fa164c16b16e88d8196da7d5@sentry.stat.yandex-team.ru/550"
...
class ExternalTestingInstallation(
    ...
    CONNECTOR_AVAILABILITY: ClassVar[ConnectorAvailabilityConfigSettings] = ConnectorAvailabilityConfigSettings(
        sections=[
            ...
            SectionSettings(
                title_translatable=TranslatableSettings(
                    text="section_title-files_and_services", domain=DOMAIN_YC_CONTROL_API
                ),
                connectors=[
                    ConnectorSettings(conn_type="file"),
    ...
    REDIS_CACHES_HOSTS: ClassVar[Tuple[str, ...]] = ("rc1b-3kj6zsk0l243g6m9.mdb.cloud-preprod.yandex.net",)
    REDIS_CACHES_PORT: ClassVar[int] = 26379

    REDIS_PERSISTENT_CLUSTER_NAME: ClassVar[str] = "misc"
    REDIS_PERSISTENT_HOSTS: ClassVar[Tuple[str, ...]] = ("rc1a-xz1b4vdkidicxyi0.mdb.cloud-preprod.yandex.net",)

    SENTRY_DSN_DATASET_API: ClassVar[str] = "https://c46c94cd48a846ed8f4d7af83258ca9f@sentry.stat.yandex-team.ru/393"
    SENTRY_DSN_PUBLIC_DATASET_API: ClassVar[
        str
    ] = "https://3be7025678354200848954c3c2909ab8@sentry.stat.yandex-team.ru/432"
    SENTRY_DSN_SEC_EMBEDS_DATASET_API: ClassVar[
        str
    ] = "https://bf28348c503f4638b3a550714e04058c@sentry.stat.yandex-team.ru/584"
    SENTRY_DSN_FILE_UPLOADER_API: ClassVar[
        str
    ] = "https://c501b388e7884ad2a6f1ffbf85cd5a85@sentry.stat.yandex-team.ru/553"
    SENTRY_DSN_FILE_UPLOADER_WORKER: ClassVar[
        str
    ] = "https://ef57d44f4c534367a85a5ebd95481a72@sentry.stat.yandex-team.ru/551"
    ...
    REDIS_RQE_CACHES_HOSTS: ClassVar[Tuple[str, ...]] = ("rc1b-zbbvgpj1d83x05qq.mdb.cloud-preprod.yandex.net",)
...
class ExternalProductionInstallation(
    ...
    DATALENS_API_LB_UPLOADS_STATUS_URL: ClassVar[
        str
    ] = "https://datalens-back.private-api.ycp.cloud.yandex.net/file-uploader"
    ...
    SENTRY_DSN_PUBLIC_DATASET_API: ClassVar[
        str
    ] = "https://d0938ee104bf4f1bbb5b62ee46f0761d@sentry.stat.yandex-team.ru/469"
    SENTRY_DSN_SEC_EMBEDS_DATASET_API: ClassVar[
        str
    ] = "https://d9549b355056427c8d67271ff8b6fd0e@sentry.stat.yandex-team.ru/585"
    SENTRY_DSN_FILE_UPLOADER_API: ClassVar[
        str
    ] = "https://3e212fd053dd43f7a4fdb870f17183fb@sentry.stat.yandex-team.ru/554"
    SENTRY_DSN_FILE_UPLOADER_WORKER: ClassVar[
        str
    ] = "https://af57c891d2a4479e8db7d392a45986ff@sentry.stat.yandex-team.ru/552"
    ...
    REDIS_RQE_CACHES_HOSTS: ClassVar[Tuple[str, ...]] = ("rc1a-h0c0k98f4p8imglf.mdb.yandexcloud.net",)
