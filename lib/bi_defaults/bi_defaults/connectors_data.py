...
SQL_YA_MUSIC_PODCASTS_STATS_STREAMS = normalize_sql_query(
    r"""
SELECT
...
SQL_YA_MUSIC_PODCASTS_STATS_SUBSCRIBERS = normalize_sql_query(
    r"""
SELECT
...
SQL_BILLING_REPORTD = normalize_sql_query(
    r"""
SELECT
...
SQL_BILLING_LABELS_MAPD = normalize_sql_query(
    r"""
SELECT
...
SQL_MARKET_COURIERS_COUR_RATING = normalize_sql_query(
    r"""
SELECT
    bench_canceled,
    bench_perenos,
...
SQL_MARKET_COURIERS_KPI_PARTNER = normalize_sql_query(
    r"""
SELECT
    cancelled_client,
    cancelled_mk,
...
SQL_MARKET_COURIERS_NEVIHOD = normalize_sql_query(
    r"""
SELECT
    company_id,
    company_name,
...
SQL_MARKET_COURIERS_OBYCHAEMOST = normalize_sql_query(
    r"""
SELECT
    account_created,
    company_id,
...
SQL_MARKET_COURIERS_DROPOFF_ORDERS = normalize_sql_query(
    r"""
SELECT
    DO_130,
    courier_company_id,
...
SQL_SCHOOLBOOK_STATS_TESTING = normalize_sql_query(
    r"""
SELECT
    *
FROM
...
SQL_SCHOOLBOOK_STATS = normalize_sql_query(
    r"""
SELECT
    *
FROM
...
SQL_SMB_HEATMAPS = normalize_sql_query(
    r"""
SELECT
    base.city_ru,
    base.coords,
...
SQL_USAGE_TRACKING = normalize_sql_query(
    r"""
SELECT
    *
...
SQL_USAGE_TRACKING_YA_TEAM = normalize_sql_query(
    r"""
SELECT
    event_time,
    request_id,
...
SQL_USAGE_TRACKING_YA_TEAM_DASH_STATS = normalize_sql_query(
    r"""
SELECT
...
SQL_USAGE_TRACKING_YA_TEAM_AGGREGATED = normalize_sql_query(
    r"""
SELECT
    event_date,
    request_count,
