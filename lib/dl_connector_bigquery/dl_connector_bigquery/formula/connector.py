...
class BigQueryFormulaConnector(FormulaConnector):
    ...
    def registration_hook(cls) -> None:
        ...
        del sa_funcs._registry["_default"]["unnest"]  # noqa  # type: ignore  # 2024-01-24 # TODO: Module has no attribute "_registry"  [attr-defined]  # type: ignore  # 2024-01-24 # TODO: Module has no attribute "_registry"  [attr-defined]
