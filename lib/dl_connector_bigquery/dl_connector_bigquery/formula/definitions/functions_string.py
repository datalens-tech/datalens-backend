...
DEFINITIONS_STRING = [
    ...
    base.FuncFind3(
        variants=[
            V(
                D.BIGQUERY,
                lambda x, y, z: n.if_(sa.func.STRPOS(sa.func.SUBSTRING(x, z), y) > 0)  # type: ignore  # 2024-01-30 # TODO: Item "IfBlockProxy" of "IfBlockProxy | IfPartProxy" has no attribute "then"  [union-attr]
