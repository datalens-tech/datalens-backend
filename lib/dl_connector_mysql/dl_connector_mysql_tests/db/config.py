...
CORE_TEST_CONFIG = CoreTestEnvironmentConfiguration(
    ...
    redis_port=get_test_container_hostport("redis-caches", fallback_port=52012).port,
)
...
DB_URLS = {
    ...
    #     D.MYSQL_8_0_12,
    #     "ssl",
    # ): f'dl_mysql://datalens:qwerty@{get_test_container_hostport("db-mysql-8-0-ssl", fallback_port=52002).as_pair()}/test_data?charset=utf8',  # /test_data?charset=utf8&ssl_ca={get_mysql_ssl_ca()}', ???
}
