...
BLACKBOX_SETTINGS_BY_NAME = {
    'Test': BlackboxSettings(
        uri='https://blackbox-test.yandex.net/blackbox', client_id_name='Test', force_tvm=False,
    ),
    'Mimino': BlackboxSettings(
        uri='https://blackbox-mimino.yandex.net/blackbox', client_id_name='Mimino', force_tvm=True,
    ),
    'Prod': BlackboxSettings(
        uri='https://blackbox.yandex.net/blackbox', client_id_name='Prod', force_tvm=True,
    ),
    'ProdYateam': BlackboxSettings(
        uri='https://blackbox.yandex-team.ru/blackbox', client_id_name='ProdYateam', force_tvm=True,
    ),
}
