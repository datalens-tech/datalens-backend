...
class ClickHouseTypeTransformer(TypeTransformer):
    native_to_user_map = {
        ...
        **{
            make_native_type(typecls): UserDataType.string
        ...
        **{
            make_native_type(ch_types.Array(typecls)): UserDataType.array_int
            for typecls in CH_TYPES_INT
        },
        **{
            make_native_type(ch_types.Array(typecls)): UserDataType.array_float
