...
class BaseClickHouseConnTargetDTO(BaseSQLConnTargetDTO, BaseAiohttpConnTargetDTO):
    ...
    endpoint: str | None = attr.ib()
    cluster_name: str | None = attr.ib()
    ...
    insert_quorum: int | None = attr.ib(kw_only=True, default=None)
    insert_quorum_timeout: int | None = attr.ib(kw_only=True, default=None)
