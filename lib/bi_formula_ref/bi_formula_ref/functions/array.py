...
from bi_formula_ref.registry.impl_selector import ArgAwareImplementationSelector
...
FUNCTION_UNNEST = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Expands the {arg:0} array expression to a set of rows."
    ),
    notes=[
        Note(_(
    ...
    examples=[
        DataExample(
            example_config=ExampleConfig(
                ...
                formula_fields=[
                    ('City', '[City]'), ('unnest_category', 'UNNEST([Category])')],
            ),
        ),
    ],
)
...
FUNCTION_CONTAINS = FunctionDocRegistryItem(
    ...
    description=_(
        "Returns `TRUE` if {arg:0} contains {arg:1}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
...
FUNCTION_CONTAINS_ALL = FunctionDocRegistryItem(
    ...
    description=_(
        "Returns `TRUE` if {arg:0} contains all elements of {arg:1}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
...
FUNCTION_CONTAINS_ANY = FunctionDocRegistryItem(
    ...
    description=_(
        "Returns `TRUE` if {arg:0} contains any elements of {arg:1}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
...
FUNCTION_STARTSWITH = FunctionDocRegistryItem(
    ...
    description=_(
        "Returns `TRUE` if {arg:0} starts with {arg:1}."
    ),
    examples=[
...
FUNCTION_ARRAY_INT = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Converts {arg:0} to an array of integers. The conversion rules are the same as for {ref:INT}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
...
FUNCTION_ARRAY_STR = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Converts {arg:0} to an array of strings. The conversion rules are the same as for {ref:STR}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
...
FUNCTION_REPLACE = FunctionDocRegistryItem(
    ...
    description=_(
        "Replaces each {arg:0} element equal to {arg:1} with {arg:2}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
...
ARRAY_AGGREGATION_FUNCTIONS_NOTE = Note(_(
...
FUNCTION_ARR_MIN = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Returns the least of elements in the {arg:0}."
    ),
...
FUNCTION_ARR_MAX = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Returns the greatest of elements in the {arg:0}."
    ),
    notes=[ARRAY_AGGREGATION_FUNCTIONS_NOTE],
    examples=[
...
FUNCTION_ARR_SUM = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Returns the sum of elements in the {arg:0}."
    ),
    notes=[ARRAY_AGGREGATION_FUNCTIONS_NOTE],
    examples=[
...
FUNCTION_ARR_AVG = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Returns the average of elements in the {arg:0}."
    ),
    notes=[ARRAY_AGGREGATION_FUNCTIONS_NOTE],
    examples=[
...
FUNCTION_ARR_PRODUCT = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Returns the product of elements in the {arg:0}."
    ),
    notes=[ARRAY_AGGREGATION_FUNCTIONS_NOTE],
    examples=[
...
FUNCTION_ARR_REMOVE = FunctionDocRegistryItem(
    ...
    category=CATEGORY_ARRAY,
    description=_(
        "Removes all {arg:0} elements equal to {arg:1}."
    ),
    examples=[
        DataExample(
            example_config=ExampleConfig(
