...
CATEGORY_WINDOW = FunctionDocCategory(
    ...
    resources=AliasedResourceRegistry(resources={
        'window_usage_restrictions': AliasedTextResource(body=_(
        ...
        'window_func_signature': AliasedTextResource(body=_(
            "```\n"
        ...
        'window_syntax': AliasedTextResource(body=_(
            "## Syntax {#syntax}\n"
            "\n"
        ...
        'window_syntax_ordering': AliasedTextResource(body=_(
        ...
        'window_syntax_bfb': AliasedTextResource(body=_(
        ...
        'agg_as_window': AliasedTextResource(body=_(
