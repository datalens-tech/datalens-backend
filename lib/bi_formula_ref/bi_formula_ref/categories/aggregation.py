...
from bi_formula_ref.registry.aliased_res import (
    AliasedResourceRegistry, AliasedTextResource,
)
...
CATEGORY_AGGREGATION = FunctionDocCategory(
    ...
    resources=AliasedResourceRegistry(resources={
        'agg_syntax': AliasedTextResource(body=_(
            "## Syntax {#syntax}\n"
            "\n"
        ...
        'agg_simple_signature': AliasedTextResource(body=_(
            "```\n"
            "AGGREGATE_FUNCTION_NAME(arg1, [arg2, ...])\n"
            "```"
        )),
        'agg_extended_signature': AliasedTextResource(body=_(
            "```\n"
        ...
        'agg_syntax_lod': AliasedTextResource(body=_(
        ...
        'agg_syntax_lod_inheritance': AliasedTextResource(body=_(
        ...
        'agg_syntax_lod_examples': AliasedTextResource(body=_(
        ...
        'agg_syntax_lod_consistency': AliasedTextResource(body=_(
        ...
        'agg_syntax_bfb': AliasedTextResource(body=_(
        ...
        'agg_usage_restrictions': AliasedTextResource(body=_(
    ...
    keywords=_(
        "aggregate functions,aggregations,aggregate data,level of detail,lod"
    ),
)
