...
from bi_file_uploader_lib.enums import FileType, CSVEncoding, RenameTenantStatus
from bi_file_uploader_lib.redis_model.models import DataFile, DataSourcePreview, RenameTenantStatusModel, PreviewSet
from bi_file_uploader_lib.redis_model.base import RedisModelNotFound
...
async def test_parse_file_task(
    ...
    assert ([sch.user_type for sch in dsrc.raw_schema] ==
            [BIType.string, BIType.integer, BIType.float, BIType.date, BIType.genericdatetime])
...
2022-06-01 10:48:45.272827'''.encode('utf-8')
...
2022-07-02 12:33:20+03'''.encode('utf-8')
