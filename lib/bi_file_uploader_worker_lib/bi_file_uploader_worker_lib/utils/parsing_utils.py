...
import sys
import io
from typing import BinaryIO, Optional, Iterator, final, Type
...
def guess_header_and_schema_gsheet(sheet: Sheet) -> tuple[bool, list[SchemaColumn], list[SchemaColumn], list[SchemaColumn]]:
    has_header, legacy_column_types, col_types_header, col_types_body = converter_parsing_utils.guess_types_and_header_gsheets(
...
def guess_header_and_schema_excel(data: list) -> tuple[bool, list[SchemaColumn], list[SchemaColumn], list[SchemaColumn]]:
    has_header, legacy_column_types, col_types_header, col_types_body = converter_parsing_utils.guess_types_and_header_excel(
        data_iter=iter(data),
        sample_lines_count=None,
    )
