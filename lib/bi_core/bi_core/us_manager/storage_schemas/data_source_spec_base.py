...
from bi_core.data_source_spec.sql import (
    SQLDataSourceSpecBase, StandardSQLDataSourceSpec, SubselectDataSourceSpec,
    StandardSchemaSQLDataSourceSpec,
)
from bi_core.us_manager.storage_schemas.base import BaseStorageSchema, CtxKey
from bi_core.us_manager.storage_schemas.index_info import DataSourceIndexInfoStorageSchema
from bi_core.us_manager.storage_schemas.raw_schema import DataSourceRawSchemaEntryStorageSchema
...
class DataSourceSpecStorageSchema(BaseStorageSchema):  # noqa
    ...
    raw_schema = ma_fields.List(
        ...
        load_default=list, allow_none=True,
    )
...
class IndexedSQLDataSourceSpecStorageSchemaMixin(BaseSQLDataSourceSpecStorageSchema):  # noqa
    index_info_set = FrozenSetField(
        ma_fields.Nested(DataSourceIndexInfoStorageSchema), sort_output=True,
...
class SchemaSQLDataSourceSpecStorageSchema(
        SchemaSQLDataSourceSpecStorageSchemaMixin,
