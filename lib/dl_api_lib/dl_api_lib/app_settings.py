...
class DeprecatedAppSettings:
    ...
    EXPORTS_HISTORY_URL_PATH: Optional[str] = s_attrib("EXPORTS_HISTORY_URL_PATH", missing=None)  # type: ignore  # 2025-08-05 # TODO: Incompatible types in assignment (expression has type "Attribute[Any]", variable has type "DataPivotEngineType | None")  [assignment]
