...
class DatasetComponentAccessor:
    ...
    def _template_source_spec(self, spec: DataSourceCollectionSpecBase) -> DataSourceCollectionSpecBase:
        # TODO: remove after refactroing ofDataSourceCollectionSpecBase
        assert isinstance(spec, DataSourceCollectionSpec)
        origin = spec.origin
