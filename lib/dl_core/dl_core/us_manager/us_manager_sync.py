...
class SyncUSManager(USManagerBase):
    ...
    def __init__(
        ...
        # caches_redis: aioredis.Redis | None = None,
    ...
    # CRUD
    #
    def save(self, entry: USEntry, update_revision: bool | None = None) -> None:
    ...
    def _ensure_conn_in_cache(self, referrer: USEntry | None, conn_ref: ConnectionRef) -> ConnectionBase | None:
