...
class FrozenSetField(fields.List):
    def _deserialize(self, value: Any, attr: str | None, data: Mapping[str, Any] | None, **kwargs: Any) -> frozenset[Any]:  # type: ignore  # 2024-01-30 # TODO: Return type "frozenset[Any]" of "_deserialize" incompatible with return type "list[Any]" in supertype "List"  [override]
        return frozenset(super()._deserialize(value, attr, data, **kwargs))

    def _serialize(self, value: Any, attr: str | None, obj: Any, **kwargs: Any) -> list[Any] | None:
...
class ErrorCodeField(fields.Field):
    def __init__(self, *args: Any, prefix: Iterable[str] | None = None, **kwargs: Any) -> None:
...
class OnOffField(fields.Field):
    ...
    def _deserialize(self, value: Any, attr: str | None, data: Mapping[str, Any] | None, **kwargs: Any) -> bool:
        if value == self.ON:
            return True
        if value == self.OFF:
            return False
