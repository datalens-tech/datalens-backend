...
from bi_connector_bundle_ch_filtered_ya_cloud.smb_heatmaps.api.api_schema.connection import (
    CHSMBHeatmapsConnectionSchema,
)
...
from bi_connector_bundle_ch_filtered_ya_cloud.smb_heatmaps.api.connection_info import (
    CHSMBHeatmapsConnectionInfoProvider,
)
