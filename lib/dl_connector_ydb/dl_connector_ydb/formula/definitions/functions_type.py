...
TYPES_SPEC = {
    ...
    for wlts in [
        ...
        base.WhitelistTypeSpec(name="Datetime", sa_type=ydb_sa.types.YqlDateTime),
        base.WhitelistTypeSpec(name="Datetime64", sa_type=ydb_sa.types.YqlDateTime64),
        base.WhitelistTypeSpec(name="Timestamp", sa_type=ydb_sa.types.YqlTimestamp),
        base.WhitelistTypeSpec(name="Timestamp64", sa_type=ydb_sa.types.YqlTimestamp64),
