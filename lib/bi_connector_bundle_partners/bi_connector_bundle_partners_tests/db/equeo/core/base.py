...
class BaseEqueoTestClass(BasePartnersClass[EqueoCHConnection]):
    ...
    def saved_connection(self, sync_us_manager: SyncUSManager, connection_creation_params: dict) -> EqueoCHConnection:
        return make_saved_equeo_connection(sync_usm=sync_us_manager, **connection_creation_params)
