...
from bi_connector_bundle_ch_filtered.usage_tracking.core.constants import CONNECTION_TYPE_USAGE_TRACKING
...
def make_saved_usage_tracking_connection(
    ...
    **kwargs: Any,
    ...
    conn_name = "usage_tracking test conn {}".format(uuid.uuid4())
    conn = UsageTrackingConnection.create_from_dict(
        UsageTrackingConnection.DataModel(
            endpoint=endpoint,
