...
def test_field_splitter():
                ...
                joined_from=JoinedFromObject(
                    ...
                    froms=[
                        ...
                        AvatarFromObject(
                            ...
                            source_id="src_2",
                            alias="ava_2",
                            columns=(FromColumn(id="zxc", name="zxc"),),
                        ),
                    ],
                ),
            ),
    ...
    mutator = SplitterMultiQueryMutator(
        splitters=[PrefilteredFieldMultiQuerySplitter(crop_to_level_type=ExecutionLevel.compeng)],
    )
    actual_result = mutator.mutate_multi_query(original_query)
    expected_result = CompiledMultiQuery(
        queries=[
                ...
                joined_from=JoinedFromObject(
                    ...
                    froms=[
                        ...
                        SubqueryFromObject(
                            ...
                            query_id="q_1",
                            alias="q_1",
                            columns=(FromColumn(id="e_2", name="e_2"),),
                        ),
                    ],
                ),
            ),
