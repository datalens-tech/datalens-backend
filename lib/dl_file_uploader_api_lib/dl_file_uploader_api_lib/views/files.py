    ...
    async def post(self) -> web.StreamResponse:
        ...
        for src in sources:
            ...
            if req_data["type"] == FileType.gsheets:
                ...
                dfile_by_source_properties[src["spreadsheet_id"]].sources.append(sheet_data_source)
                ...
                dfile_by_source_properties[src[filled_source_property]].sources.append(sheet_data_source)
