...
def _test_chyt_to_chyt(api_v1, client, conn_id, new_conn_id, create_ds_from, expected_source_type):
    src_kwargs = dict(
...
def test_chyt_to_chyt(
    api_v1,
    client,
    public_ch_over_yt_connection_id,
    public_ch_over_yt_second_connection_id,
...
def test_chyt_user_auth_to_chyt(
    api_v1_with_token,
    client,
    public_ch_over_yt_user_auth_connection_id,
    public_ch_over_yt_connection_id,
    public_ch_over_yt_user_auth_headers,
):
    _test_chyt_to_chyt(
