...
@pytest.mark.parametrize(
    "yenv_type,app_type,minimal_env,settings_cls",
    (
        # Internal
...
def test_yaml_file_config_resolver():
    ...
    assert YamlFileConfigResolver().is_config_enabled(s_dict={YamlFileConfigResolver.config_path_key: "bla"}) is True
