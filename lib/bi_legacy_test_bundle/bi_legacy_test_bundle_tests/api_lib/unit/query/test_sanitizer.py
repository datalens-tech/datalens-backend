...
def test_join_sanitizing():
    base_avatars = {
        "ava_0": AvatarFromObject(
            id="ava_0", avatar_id="ava_0", source_id="src_0", alias="ava_0", columns=(FromColumn(id="c_0", name="c_0"),)
        ),
        "ava_1": AvatarFromObject(
            id="ava_1", avatar_id="ava_1", source_id="src_1", alias="ava_1", columns=(FromColumn(id="c_1", name="c_1"),)
        ),
        "ava_3": AvatarFromObject(
            id="ava_3", avatar_id="ava_3", source_id="src_3", alias="ava_3", columns=(FromColumn(id="c_3", name="c_3"),)
        ),
    }
    compiled_multi_query = CompiledMultiLevelQuery(
        levels=[
