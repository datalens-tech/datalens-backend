...
def test_at_date(api_v1, data_api_v2, dataset_id):
    ...
    data_rows = get_data_rows(result_resp)
    _check_at_date_data(
        data_rows=data_rows, date_idx=1, value_idx=2, ago_idx=3, ago_date_callable=lambda d: datetime.date(2014, 2, 2)
    )
    _check_at_date_data(
        data_rows=data_rows, date_idx=1, value_idx=2, ago_idx=4, ago_date_callable=lambda d: datetime.date(2014, 2, 2)
    )
    _check_at_date_data(
