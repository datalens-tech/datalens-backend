...
from dl_api_lib.schemas.action import (
...
def get_updates(field_id):
    return [{"action": "update_field", "field": {"guid": field_id, "cast": "integer"}, "order_index": 0}]
...
async def _save_to_cache(
    cache: USEntryMutationCache, ds_for_key: UsDataset, ds_for_save: UsDataset, key: UpdateDatasetMutationKey
):
...
def test_save_to_cache(
    api_v1,
    data_api_v2_with_mutation_cache,
    mutation_cache,
    loop,
    dataset_id,
