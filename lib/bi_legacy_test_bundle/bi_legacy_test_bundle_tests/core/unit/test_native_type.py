...
SAMPLE_NATIVE_TYPES = (
    ...
    LengthedNativeType(conn_type=CONNECTION_TYPE_ORACLE, name="nvarchar2", nullable=False, length=121),
    ClickHouseNativeType(conn_type=CONNECTION_TYPE_CLICKHOUSE, name="uint64", nullable=True, lowcardinality=True),
    ClickHouseDateTimeWithTZNativeType(
