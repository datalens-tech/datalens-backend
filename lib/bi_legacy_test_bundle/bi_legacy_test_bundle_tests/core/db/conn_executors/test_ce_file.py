...
from bi_legacy_test_bundle_tests.core.common_ce import SelectDataTestSet, ErrorTestSet
    ...
    async def test_date32(self, executor, s3_tbl_func_local, s3_native_from_ch_table):
        query = executor.execute(query=ConnExecutorQuery(
            query="SELECT toDate32('1931-01-01') "
                  ...
                  "ORDER BY res_0\n "
                  "LIMIT 0, 100",
            trusted_query=True, chunk_size=6, ), )
        result = await query
