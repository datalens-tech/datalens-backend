...
async def test_integration_conn_executor_factory(
        aiohttp_client, rqe_config_subprocess, saved_pg_connection, caplog,
        core_test_config):
    ...
    app = web.Application(middlewares=[
        ...
        services_registry_middleware(DefaultSRFactory(
            async_env=True,
...
async def test_integration_compeng_configured_case(
    aiohttp_client, rqe_config_subprocess, compeng_pg_dsn, compeng_type, caplog,
    core_test_config, saved_ch_dataset,
):
