...
WILDCARD_EXPECTED_RESTRICTIONS = {
    ...
    "user_3": {"fld1": ["f1_val_1_for_all", "f1_val_2_for_all", "f1_val_for_u3_u4"], "fld2": ["f2_val_1_for_all"]},
    "user_4": {
        "fld1": ["f1_val_1_for_all", "f1_val_2_for_all", "f1_val_for_u3_u4"],
        "fld2": ["f2_val_1_for_all", "f2_val_for_u4"],
    },
    "user_5": {"fld1": ["f1_val_1_for_all", "f1_val_2_for_all", "f1_val_for_u5"], "fld2": ["f2_val_1_for_all"]},
}
...
def test_rls_wildcards(default_sync_usm, dataset_for_rls):
    ...
    entrysets = {field_alias_to_guid[field_name]: entries for field_name, entries in entrysets.items()}
    assert not dataset.rls.has_restrictions
