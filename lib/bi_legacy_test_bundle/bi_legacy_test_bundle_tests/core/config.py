...
def get_test_container_hostport(
    ...
    return _get_test_container_hostport(
        service_key=service_key, original_port=original_port,
        fallback_port=fallback_port, dc_filename=DOCKER_COMPOSE_FILE_NAME,
    )
...
DS_STORE_CH_URL = f'bi_clickhouse://datalens:qwerty@' \
