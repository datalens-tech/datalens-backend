...
from bi_file_uploader_lib.exc import InvalidLink
from bi_file_uploader_lib.redis_model.models.models import GSheetsUserSourceProperties
...
async def gsheets_data_file_preparer(
    ...
    example_url: str = 'https://docs.google.com/spreadsheets/d/1zRPTxxLOQ08n0_MReIBbouAbPFw6pJ4ibNSVdFkZ3gs/edit#gid=1140182768'
