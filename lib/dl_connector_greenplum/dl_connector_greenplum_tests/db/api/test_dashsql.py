...
from dl_connector_greenplum_tests.db.api.base import (
    GP6DashSQLConnectionTest,
    GP7DashSQLConnectionTest,
)
from dl_connector_greenplum_tests.db.config import DASHSQL_QUERY


class GreenplumDashSQLTestSuite(DefaultDashSQLTestSuite, metaclass=abc.ABCMeta):
    @pytest.mark.asyncio
...
class TestGP6DashSQL(GP6DashSQLConnectionTest, GreenplumDashSQLTestSuite):
    pass


class TestGP7DashSQL(GP7DashSQLConnectionTest, GreenplumDashSQLTestSuite):
    pass
