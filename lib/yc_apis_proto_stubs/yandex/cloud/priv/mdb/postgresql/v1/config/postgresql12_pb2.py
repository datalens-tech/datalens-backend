...
# source: yandex/cloud/priv/mdb/postgresql/v1/config/postgresql12.proto
...
PostgresqlConfig12 = _reflection.GeneratedProtocolMessageType('PostgresqlConfig12', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.priv.mdb.postgresql.v1.config.postgresql12_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.priv.mdb.postgresql.v1.config.PostgresqlConfig12)
  })
...
PostgresqlConfigSet12 = _reflection.GeneratedProtocolMessageType('PostgresqlConfigSet12', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.priv.mdb.postgresql.v1.config.postgresql12_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.priv.mdb.postgresql.v1.config.PostgresqlConfigSet12)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _POSTGRESQLCONFIG12.fields_by_name['bgwriter_delay']._serialized_options = b'\272\2111\01010-10000'
  _POSTGRESQLCONFIG12.fields_by_name['bgwriter_flush_after']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['bgwriter_flush_after']._serialized_options = b'\272\2111\0060-2048'
  _POSTGRESQLCONFIG12.fields_by_name['backend_flush_after']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['backend_flush_after']._serialized_options = b'\272\2111\0060-2048'
  _POSTGRESQLCONFIG12.fields_by_name['old_snapshot_threshold']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['old_snapshot_threshold']._serialized_options = b'\272\2111\013-1-86400000'
  _POSTGRESQLCONFIG12.fields_by_name['checkpoint_timeout']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['checkpoint_timeout']._serialized_options = b'\272\2111\01630000-86400000'
  _POSTGRESQLCONFIG12.fields_by_name['checkpoint_flush_after']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['checkpoint_flush_after']._serialized_options = b'\272\2111\0060-2048'
  _POSTGRESQLCONFIG12.fields_by_name['from_collapse_limit']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['from_collapse_limit']._serialized_options = b'\272\2111\0141-2147483647'
  _POSTGRESQLCONFIG12.fields_by_name['join_collapse_limit']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['join_collapse_limit']._serialized_options = b'\272\2111\0141-2147483647'
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_max_workers']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_max_workers']._serialized_options = b'\272\2111\0041-32'
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_vacuum_cost_delay']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_vacuum_cost_delay']._serialized_options = b'\272\2111\006-1-100'
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_vacuum_cost_limit']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_vacuum_cost_limit']._serialized_options = b'\272\2111\010-1-10000'
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_naptime']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_naptime']._serialized_options = b'\272\2111\r1000-86400000'
  _POSTGRESQLCONFIG12.fields_by_name['archive_timeout']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['archive_timeout']._serialized_options = b'\272\2111\01610000-86400000'
  _POSTGRESQLCONFIG12.fields_by_name['track_activity_query_size']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['track_activity_query_size']._serialized_options = b'\272\2111\n100-102400'
  _POSTGRESQLCONFIG12.fields_by_name['max_worker_processes']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['max_worker_processes']._serialized_options = b'\272\2111\0060-1024'
  _POSTGRESQLCONFIG12.fields_by_name['max_parallel_workers']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['max_parallel_workers']._serialized_options = b'\272\2111\0060-1024'
  _POSTGRESQLCONFIG12.fields_by_name['max_parallel_workers_per_gather']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['max_parallel_workers_per_gather']._serialized_options = b'\272\2111\0060-1024'
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_vacuum_scale_factor']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_vacuum_scale_factor']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_analyze_scale_factor']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['autovacuum_analyze_scale_factor']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['max_parallel_maintenance_workers']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['max_parallel_maintenance_workers']._serialized_options = b'\272\2111\003>=0'
  _POSTGRESQLCONFIG12.fields_by_name['vacuum_cleanup_index_scale_factor']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['vacuum_cleanup_index_scale_factor']._serialized_options = b'\272\2111\0210.0-10000000000.0'
  _POSTGRESQLCONFIG12.fields_by_name['log_transaction_sample_rate']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['log_transaction_sample_rate']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['effective_io_concurrency']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['effective_io_concurrency']._serialized_options = b'\272\2111\0060-1000'
  _POSTGRESQLCONFIG12.fields_by_name['effective_cache_size']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['effective_cache_size']._serialized_options = b'\272\2111\0160-549755813888'
  _POSTGRESQLCONFIG12.fields_by_name['auto_explain_log_min_duration']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['auto_explain_log_min_duration']._serialized_options = b'\272\2111\r-1-2147483647'
  _POSTGRESQLCONFIG12.fields_by_name['auto_explain_sample_rate']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['auto_explain_sample_rate']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['max_stack_depth']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['max_stack_depth']._serialized_options = b'\272\2111\01765536-134217728'
  _POSTGRESQLCONFIG12.fields_by_name['geqo_effort']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['geqo_effort']._serialized_options = b'\272\2111\0041-10'
  _POSTGRESQLCONFIG12.fields_by_name['geqo_selection_bias']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['geqo_selection_bias']._serialized_options = b'\272\2111\0071.5-2.0'
  _POSTGRESQLCONFIG12.fields_by_name['geqo_seed']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['geqo_seed']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['pg_trgm_similarity_threshold']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['pg_trgm_similarity_threshold']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['pg_trgm_word_similarity_threshold']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['pg_trgm_word_similarity_threshold']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['pg_trgm_strict_word_similarity_threshold']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['pg_trgm_strict_word_similarity_threshold']._serialized_options = b'\272\2111\0070.0-1.0'
  _POSTGRESQLCONFIG12.fields_by_name['session_duration_timeout']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['session_duration_timeout']._serialized_options = b'\272\2111\0140-2147483647'
  _POSTGRESQLCONFIG12.fields_by_name['log_autovacuum_min_duration']._options = None
  _POSTGRESQLCONFIG12.fields_by_name['log_autovacuum_min_duration']._serialized_options = b'\272\2111\r-1-2147483647'
  _POSTGRESQLCONFIG12._serialized_start=178
  _POSTGRESQLCONFIG12._serialized_end=12477
  _POSTGRESQLCONFIG12_BACKSLASHQUOTE._serialized_start=9857
  _POSTGRESQLCONFIG12_BACKSLASHQUOTE._serialized_end=10011
  _POSTGRESQLCONFIG12_BYTEAOUTPUT._serialized_start=10013
  _POSTGRESQLCONFIG12_BYTEAOUTPUT._serialized_end=10104
  _POSTGRESQLCONFIG12_CONSTRAINTEXCLUSION._serialized_start=10107
  _POSTGRESQLCONFIG12_CONSTRAINTEXCLUSION._serialized_end=10261
  _POSTGRESQLCONFIG12_FORCEPARALLELMODE._serialized_start=10264
  _POSTGRESQLCONFIG12_FORCEPARALLELMODE._serialized_end=10410
  _POSTGRESQLCONFIG12_LOGERRORVERBOSITY._serialized_start=10413
  _POSTGRESQLCONFIG12_LOGERRORVERBOSITY._serialized_end=10566
  _POSTGRESQLCONFIG12_LOGLEVEL._serialized_start=10569
  _POSTGRESQLCONFIG12_LOGLEVEL._serialized_end=10863
  _POSTGRESQLCONFIG12_LOGSTATEMENT._serialized_start=10866
  _POSTGRESQLCONFIG12_LOGSTATEMENT._serialized_end=11004
  _POSTGRESQLCONFIG12_PGHINTPLANDEBUGPRINT._serialized_start=11007
  _POSTGRESQLCONFIG12_PGHINTPLANDEBUGPRINT._serialized_end=11215
  _POSTGRESQLCONFIG12_PLANCACHEMODE._serialized_start=11218
  _POSTGRESQLCONFIG12_PLANCACHEMODE._serialized_end=11371
  _POSTGRESQLCONFIG12_SHAREDPRELOADLIBRARIES._serialized_start=11374
  _POSTGRESQLCONFIG12_SHAREDPRELOADLIBRARIES._serialized_end=11768
  _POSTGRESQLCONFIG12_SYNCHRONOUSCOMMIT._serialized_start=11771
  _POSTGRESQLCONFIG12_SYNCHRONOUSCOMMIT._serialized_end=11985
  _POSTGRESQLCONFIG12_TRANSACTIONISOLATION._serialized_start=11988
  _POSTGRESQLCONFIG12_TRANSACTIONISOLATION._serialized_end=12218
  _POSTGRESQLCONFIG12_WALLEVEL._serialized_start=12220
  _POSTGRESQLCONFIG12_WALLEVEL._serialized_end=12303
  _POSTGRESQLCONFIG12_XMLBINARY._serialized_start=12305
  _POSTGRESQLCONFIG12_XMLBINARY._serialized_end=12387
  _POSTGRESQLCONFIG12_XMLOPTION._serialized_start=12389
  _POSTGRESQLCONFIG12_XMLOPTION._serialized_end=12477
  _POSTGRESQLCONFIGSET12._serialized_start=12480
  _POSTGRESQLCONFIGSET12._serialized_end=12766
