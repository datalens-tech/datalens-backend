...
CORE_TEST_CONFIG = CoreTestEnvironmentConfiguration(
    ...
    redis_port=get_test_container_hostport("redis-caches", fallback_port=52112).port,
)

COMPOSE_PROJECT_NAME = os.environ.get("COMPOSE_PROJECT_NAME", "dl_connector_mssql")
...
ADMIN_URL = (
    f'mssql+pyodbc:///?odbc_connect=DRIVER%3D%7BFreeTDS%7D%3BServer%3D{get_test_container_hostport("db-mssql-14", fallback_port=52100).host}%3B'
    f'Port%3D{get_test_container_hostport("db-mssql-14", fallback_port=52100).port}%3BUID%3Dsa%3BPWD%3DqweRTY123%3BTDS_Version%3D8.0'
)
ADMIN_W_DB_URL = (
    f'mssql+pyodbc:///?odbc_connect=DRIVER%3D%7BFreeTDS%7D%3BServer%3D{get_test_container_hostport("db-mssql-14", fallback_port=52100).host}%3B'
    f'Port%3D{get_test_container_hostport("db-mssql-14", fallback_port=52100).port}%3BDatabase%3Dtest_data%3BUID%3Dsa%3BPWD%3DqweRTY123%3BTDS_Version%3D8.0'
)
DB_CORE_URL = _DB_URL
DB_URLS = {
