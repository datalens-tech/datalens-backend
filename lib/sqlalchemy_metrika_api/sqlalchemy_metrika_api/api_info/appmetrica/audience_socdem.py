audience_socdem_fields = [
    {"description": "", "is_dim": False, "name": "ym:u:sessions", "title": "Количество сессий", "type": "integer"},
    {"description": "", "is_dim": False, "name": "ym:u:newUsers", "title": "Новые пользователи", "type": "integer"},
    {"description": "", "is_dim": False, "name": "ym:u:activeUsers", "title": "Пользователи", "type": "integer"},
    {
    ...
    {"description": None, "is_dim": True, "name": "ym:u:isRooted", "title": "Root-статус", "type": "string"},
    {
    ...
    {"description": None, "is_dim": True, "name": "ym:u:appVersion", "title": "Версия приложения", "type": "string"},
    {"description": None, "is_dim": True, "name": "ym:u:year", "title": "Год", "type": "integer"},
    {
    ...
    {"description": None, "is_dim": True, "name": "ym:u:date", "title": "Дата", "type": "date"},
    {
    ...
    {"description": None, "is_dim": True, "name": "ym:u:startOfQuarter", "title": "Дата (квартал)", "type": "date"},
    {
    ...
    {"description": None, "is_dim": True, "name": "ym:u:dekaminute", "title": "Декаминута", "type": "string"},
    {"description": None, "is_dim": True, "name": "ym:u:dayOfMonth", "title": "День месяца", "type": "integer"},
    {"description": None, "is_dim": True, "name": "ym:u:dayOfWeekName", "title": "День недели", "type": "string"},
    {
        "description": None,
        "is_dim": True,
        "name": "ym:u:appID",
    ...
    {"description": None, "is_dim": True, "name": "ym:u:month", "title": "Месяц", "type": "integer"},
    {"description": None, "is_dim": True, "name": "ym:u:minute", "title": "Минута", "type": "integer"},
    {"description": None, "is_dim": True, "name": "ym:u:mobileDeviceModel", "title": "Модель", "type": "string"},
    {
        "description": None,
        "is_dim": True,
        "name": "ym:u:mpcName",
    ...
    {"description": None, "is_dim": True, "name": "ym:u:regionAreaName", "title": "Область", "type": "string"},
    {
        "description": None,
        "is_dim": True,
    ...
    {"description": None, "is_dim": True, "name": "ym:u:deviceTypeName", "title": "Тип устройства", "type": "string"},
    {"description": None, "is_dim": True, "name": "ym:u:hour", "title": "Час", "type": "string"},
    {"description": None, "is_dim": True, "name": "ym:u:hourMinute", "title": "Час и минута", "type": "string"},
    {"description": None, "is_dim": True, "name": "ym:u:locale", "title": "Язык интерфейса", "type": "string"},
]
