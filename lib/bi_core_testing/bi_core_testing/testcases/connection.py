...
import abc
from typing import Callable, ClassVar, Generic, TypeVar, Optional, TYPE_CHECKING
...
class BaseConnectionTestClass(
    ...
    def sync_conn_executor_factory(
            self, saved_connection: _CONN_TV, conn_sync_service_registry: ServicesRegistry,
    ...
    def async_conn_executor_factory(
            self, saved_connection: _CONN_TV, conn_async_service_registry: ServicesRegistry,
...
class DefaultConnectionTestClass(BaseConnectionTestClass[_CONN_TV], Generic[_CONN_TV]):
    ...
    def test_connection_data_export_flag(
            self, saved_connection: ConnectionBase, sync_us_manager: SyncUSManager,
    ) -> None:
