...
DEFINITIONS_TYPE = [
    ...
    base.FuncDate1FromNumber(variants=[
        V(D.BIGQUERY, lambda expr: sa.cast(sa.func.TIMESTAMP_SECONDS(sa.cast(expr, sa.INTEGER)), sa.DATE))
    ]),
    ...
    base.FuncStrFromBool(variants=[
        V(D.BIGQUERY, lambda value: sa.case(
