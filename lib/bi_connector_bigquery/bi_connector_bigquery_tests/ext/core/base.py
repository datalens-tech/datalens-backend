...
from bi_connector_bigquery.core.testing.connection import make_bigquery_saved_connection

import bi_connector_bigquery_tests.ext.config as test_config
...
class BaseBigQueryTestClass(BaseConnectionTestClass[ConnectionSQLBigQuery]):
    ...
    def saved_connection(
        ...
        conn = make_bigquery_saved_connection(
